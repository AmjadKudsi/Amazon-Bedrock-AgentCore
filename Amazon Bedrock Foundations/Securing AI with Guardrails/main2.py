# extend the existing guardrail configuration to include both violence and hate speech filtering
...
response = control.create_guardrail(
    ...
    contentPolicyConfig={
        "filtersConfig": [
            ...
            # TODO: Add a HATE filter with "HIGH" input strength and "NONE" output strength
