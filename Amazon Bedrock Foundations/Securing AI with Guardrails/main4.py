# there is a problem with the send_message() function that prevents the guardrails from working properly
# debug and fix the issues in the send_message() function
...
def send_message(user_text):
    try:
        ...
        # Handle blocked messages by removing them from conversation history
