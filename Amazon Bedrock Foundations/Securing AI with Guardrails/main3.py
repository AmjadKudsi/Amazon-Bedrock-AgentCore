# add protection against financial advice request
...
response = control.create_guardrail(
    ...
    topicPolicyConfig={
        "topicsConfig": [
            ...
            # TODO: Add a new topic configuration for "Financial Advice" with appropriate definition, examples, and type
            {
                "name": "Financial Advice",
                "definition": (
                    "Content that provides personalized or general advice about investing, buying or selling securities, financial planning, or predicting market performance."
                ),
                "examples": [
...
# TODO: Add a fourth turn that asks for financial advice (e.g., "Should I buy Amazon stock?") and print the result
