...
prog_lang_template = (
    "Based on all the information you provided, can you give me some implementation examples"
    "specifically for {language} programming language?"
)

# Set variables for template substitution
aws_service = "Amazon Bedrock"
topic = "cost optimization strategies"
# TODO: Define a language variable for your third template
language = "Python"
...
user_message_3 = prog_lang_template.format(language=language)
