...
# TODO: Format the detailed_overview_template using the aws_service variable and assign to user_message_1
# TODO: Call send_message with user_message_1 and assign the result to response_1
# TODO: Print the user message and assistant response for Turn 1
...
# TODO: Format the specific_topic_template using the topic variable and assign to user_message_2
# TODO: Call send_message with user_message_2 and assign the result to response_2
# TODO: Print the user message and assistant response for Turn 2
