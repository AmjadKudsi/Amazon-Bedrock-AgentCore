...
# TODO: Import BedrockAgentCoreApp from bedrock_agentcore.runtime
...
# TODO: Create the Bedrock AgentCore Runtime app wrapper
app = BedrockAgentCoreApp()

# TODO: Print the routes to see what HTTP endpoints are created
print(app.routes)
