# complete the missing configuration to establish a connection with the AWS documentation MCP server
...
stdio_mcp_client = MCPClient(
    lambda: stdio_client(
        StdioServerParameters(
            command="uvx",   # TODO: Set the correct command
            args=["awslabs.aws-documentation-mcp-server@latest"]       # TODO: Set the correct args
        )
    )
)
