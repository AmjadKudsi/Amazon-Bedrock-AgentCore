# implement a function that returns AWS service information in JSON format, making it accessible to your agent
...
agent = Agent(
    ...
    # TODO: Pass the custom tool to the agent
    tools=[get_aws_resource_specs]
)
