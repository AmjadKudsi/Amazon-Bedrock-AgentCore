# create a meaningful conversation flow by adding at least one more AWS-related questions that build upon the previous one
...
# TODO: Add at least one more related AWS questions to create a conversation flow
agent("What are the main differences between AWS Bedrock and Amazon SageMaker?")