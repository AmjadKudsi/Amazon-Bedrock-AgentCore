# create the Agent instance that brings the model for generating responses and the system_prompt that defines its behavior together
...
# TODO: Create an agent with the Bedrock model and AWS Technical Assistant system prompt
agent = Agent(
    model=model,
