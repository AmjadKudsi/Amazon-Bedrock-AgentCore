# finish the provided code by extracting and displaying the results from your RAG queries
...
try:
    ...
    for query in rag_queries:
        ...
        # TODO: Extract the generated answer from the response and print it
    answer = response["output"]["text"]
    print(f"Answer: {answer}")
        
        # TODO: Get the citations from the response and display source documents
        # Handle the case where citations may or may not be present
