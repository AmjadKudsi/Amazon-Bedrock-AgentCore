# complete the missing components in the direct vector search implementation that converts text queries into numerical vectors
...
try:
    ...
    # TODO: Create the query_embedding_request dictionary with inputText, dimensions, and normalize fields
